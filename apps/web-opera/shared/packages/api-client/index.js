const endpoints = {
  ...
  artists: '/api/v1/opera/artists',
  artistDetail: (id) => `/api/v1/opera/artists/${encodeURIComponent(id)}`,
  organizations: '/api/v1/opera/organizations',
  organizationDetail: (id) => `/api/v1/opera/organizations/${encodeURIComponent(id)}`,
  performances: '/api/v1/opera/performances',
...
function createClient(transport) {
  ...
  return {
    ...
    getArtists: (query) => get(endpoints.artists, query),
    getArtist: (id) => get(endpoints.artistDetail(id)),
    getOrganizations: (query) => get(endpoints.organizations, query),
    getOrganization: (id) => get(endpoints.organizationDetail(id)),
    getPerformances: (query) => get(endpoints.performances, query),
